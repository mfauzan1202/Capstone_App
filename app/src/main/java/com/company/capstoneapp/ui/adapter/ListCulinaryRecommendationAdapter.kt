...
class ListCulinaryRecommendationAdapter(options: FirebaseRecyclerOptions<Culinary>) : FirebaseRecyclerAdapter<Culinary, ListCulinaryRecommendationAdapter.ListViewHolder>(options) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListCulinaryRecommendationAdapter.ListViewHolder {
    ...
    override fun onBindViewHolder(holder: ListCulinaryRecommendationAdapter.ListViewHolder, position: Int, model: Culinary) {
